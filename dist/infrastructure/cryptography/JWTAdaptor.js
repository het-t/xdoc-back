...
exports.JWTAdaptor = void 0;
const jwt = __importStar(require("jsonwebtoken"));
class JWTAdaptor {
    constructor(authenticationTokenSecret, refreshTokenSecret) {
        this.authenticationTokenSecret = authenticationTokenSecret;
