...
class CreateWorkspaceController extends BaseController_1.BaseController {
    constructor(createWorkspace) {
        super();
    ...
    execute(httpRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const workspaceOrError = yield this.createWorkspace.execute({
                name,
                icon,
                favourites
            });
